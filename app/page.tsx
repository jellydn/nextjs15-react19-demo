		...
		<div className="grid gap-16 justify-items-center items-center p-8 pb-20 min-h-screen font-sans sm:p-20 grid-rows-[20px_1fr_20px]">
			<main className="flex flex-col row-start-2 gap-8 items-center sm:items-start">
				<Image
					...
					priority
				/>
				<ol className="font-mono text-sm list-decimal list-inside text-center sm:text-left">
					<li className="mb-2">
						Get started by editing{" "}
						<code className="py-0.5 px-1 font-semibold rounded bg-black/[.05] dark:bg-white/[.06]">
							app/page.tsx
						</code>
					</li>
